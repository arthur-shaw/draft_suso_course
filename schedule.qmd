...
schedule_df <- tibble::tribble(
    ...
    # Interviewer
    "Interviewer",  "Set up Interviewer", NA, "slides/03_interviewer/01_setup/01_setup_interviewer.qmd",   NA,
    "Interviewer",  "Use Interviewer", NA, "slides/03_interviewer/02_use/02_use_interviewer.qmd",   NA,
    # Managing a survey
