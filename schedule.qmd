...
schedule_df <- tibble::tribble(
    ...
    # Supervisor
    "Supervisor",  "Set up Supervisor", NA, "slides/04_supervisor/01_setup/01_supervisor_setup.qmd",   NA,
    "Supervisor",  "Use Supervisor", NA, "slides/04_supervisor/02_use/02_supervisor_use.qmd",   NA,
    # Interviewer
